    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="${pageContext.request.contextPath }/sm/WAIT/1/order">주문 내역</a>
            </li>
            <li class="nav-item">
...
<div>
    ...
    <div class="container-fluid">
        ...
        <div class="form-group row">
            <label style="font-family:'Do Hyeon'; font-size:23px; font-weight:bold;" for="pay_id" class="col-3 col-form-label">주문자</label>
            <div class="col-9">
                <input style="font-size:20px;" type="text" class="form-control" id="pay_id" value="${order.user.name}" readonly>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-9">
                <input style="font-size:20px;" type="text" class="form-control" id="get_time" value="${order.pickupDate}" readonly>
            </div>
        </div>
